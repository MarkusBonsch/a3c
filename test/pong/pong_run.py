...
def netMaker():
    ...
    params = mx.gluon.nn.SymbolBlock.imports(symbol_file = "/home/markus/Documents/Nerding/python/a3c/test/pong/tmp/trial2_____continued/120/net-symbol.json",
                                      param_file  = "/home/markus/Documents/Nerding/python/a3c/test/pong/tmp/trial2_____continued/120/net-0001.params",
                                      input_names = ['data'])
...
mainThread = mT(netMaker   = netMaker , 
                ...
                outputDir  = 'a3c/test/pong/trial2_____continued', 
                saveInterval = 20,
                verbose    = False)
